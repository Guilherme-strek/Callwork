...
@Component({
      ...
      <div class="layout" style="margin-top:16px">
        <div class="stack">
          <div class="card card-pad row" style="align-items:center">
            ...
            <div>
              ...
              <p class="small muted" style="margin-top:4px">
                <span class="stars">★★★★★</span> {{ p.rating }} · {{ p.reviewsCount }} avaliações · responde em ~1h
              </p>
            </div>
          </div>
          ...
          <div class="card card-pad">
            ...
            <p class="muted small" style="line-height:1.6">{{ p.about }}</p>
          </div>
          ...
          <div class="card card-pad">
            ...
            <div *ngFor="let r of p.reviews" class="review">
              <p class="small">
                <span class="stars">★★★★★</span> <strong>{{ r.author }}</strong>
              </p>
        ...
        <aside class="stack sticky">
          <div class="card card-pad">
            ...
            <p *ngIf="enviado" class="small" style="color:var(--brand-700);margin-top:10px">
  ...
  styles: [
    `
      ...
      .svc { display: flex; justify-content: space-between; font-size: 0.9rem; padding: 8px 0; border-bottom: 1px solid var(--line); }
      .svc:last-of-type { border-bottom: 0; }
      @media (max-width: 820px) { .layout { grid-template-columns: 1fr; } .sticky { position: static; } }
    `,
  ],
})
export class PerfilComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private api: CallWorkApi) {}
