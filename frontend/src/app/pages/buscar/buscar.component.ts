  ...
  template: `
    <div class="container" style="padding:24px 20px">
      ...
      <div class="row" style="flex-wrap:wrap">
        ...
        <span class="loc">📍 Maringá, PR</span>
      </div>
      ...
      <div class="layout">
        ...
        <section>
          <p class="muted small" style="margin-bottom:12px">
            {{ lista.length }} profissionais em Maringá, PR
          </p>

          <p *ngIf="carregando" class="muted">Carregando…</p>

          <div *ngIf="!carregando && lista.length === 0" class="card card-pad empty">
          ...
          <div class="results">
            ...
            >
              <div class="row" style="align-items:center">
                ...
                <span
                  class="badge"
                  [class.badge-ok]="p.meiVerified"
                  [class.badge-muted]="!p.meiVerified"
                  >{{ p.meiVerified ? '✔ MEI' : 'Autônomo' }}</span
                >
              </div>
              <div class="row" style="justify-content:space-between;margin-top:10px">
                <span class="small muted"><span class="stars">★</span> {{ p.rating }} · {{ p.reviewsCount }} aval.</span>
